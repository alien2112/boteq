 ...
 * Preserves Arabic characters for SEO-friendly Arabic URLs
 */
 ...
 * Filters out common stop words (Arabic and English)
 */
export function extractKeywords(text: string, maxKeywords: number = 10): string[] {
    const stopWords = new Set([
        ...
        'التي', 'الذي', 'اللتي', 'الذين', 'هو', 'هي', 'هم', 'نحن', 'أنت',
        'أنتم', 'أن', 'إن', 'كان', 'كانت', 'يكون', 'تكون', 'قد', 'لقد',
        'كل', 'بعض', 'أي', 'أو', 'و', 'ثم', 'لكن', 'إذا', 'عند', 'حتى',
    ]);
...
export function generateSEOMetadata(
    ...
    // Generate slug from title (preserves Arabic)
